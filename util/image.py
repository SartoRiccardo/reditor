...
FONT = ImageFont.truetype(util.paths.DATA_PATH + "/assets/thumbnail/thumbnail-font-bold.ttf", 100)
WATERMARK_PATH = util.paths.DATA_PATH + "/assets/thumbnail/watermark.png"
